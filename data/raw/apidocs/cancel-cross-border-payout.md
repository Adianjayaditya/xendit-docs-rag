---
url: https://docs.xendit.co/apidocs/cancel-cross-border-payout
title: "Cancel cross-border payout"
section: apidocs
product: xendit
---
...
- - [API Documentation](/apidocs)
  ...
  - [Cross-Border Payout](/apidocs/create-cross-border-payout)
...
- Published on Feb 11, 2025
 ...
 [Prev](/apidocs/get-cross-border-payout "Get cross-border payout by Id")  [Next](/apidocs/introduction-1 "Introduction") 

Get

/remittance\_payouts/{cross\_border\_payout\_id}/cancel
...
Cancellation is only allowed when status is `ACCEPTED` or `PENDING_COMPLIANCE_ASSESSMENT`
...
Cross-Border Payout Cancelled

application/json

cancelCrossBorderPayoutResponseExample
...
400CancellationNotAllowedError

object (400CancellationNotAllowedError)

error\_code

string

ExampleCANCELLATION\_NOT\_ALLOWED

error\_message

string

ExamplePayout cannot be canceled because it has already been processed by Xendit
