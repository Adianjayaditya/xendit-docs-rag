---
url: https://docs.xendit.co/apidocs/get-list-of-subscription-cycles-2
title: "Get List of Subscription Cycles"
section: apidocs
product: xendit
---
...
- Published on Apr 7, 2026
 ...
 [Prev](/apidocs/deactivate-subscription-plan-2 "Deactivate Subscription Plan")  [Next](/apidocs/get-subscription-cycle-2 "Get Subscription Cycle") 
...
Maximum number of entities to be returned in API response
...
Fetch cycles created before the creation of the cycle with this ID

after\_id

string

Fetch cycles created after the creation of the cycle with this ID
...
Array of object (Xendit\_Subscriptions\_API\_RecurringCycle)
