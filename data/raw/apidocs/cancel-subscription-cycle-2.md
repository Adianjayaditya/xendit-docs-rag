---
url: https://docs.xendit.co/apidocs/cancel-subscription-cycle-2
title: "Cancel Subscription Cycle"
section: apidocs
product: xendit
---
...
# Cancel Subscription Cycle

- Updated on Apr 8, 2026
- Published on Apr 7, 2026

 [Prev](/apidocs/update-subscription-cycle-2 "Update Subscription Cycle")  [Next](/apidocs/force-attempt-subscription-cycle-2 "Force Attempt Subscription Cycle") 

Post

/recurring/plans/{plan\_id}/cycles/{id}/cancel

Cancel a cycle plan. Once the cycle is canceled, it will not deduct the end user's balance on the scheduled cycle date.
...
Successfully cancel the recurring cycle.
...
```
{
  ...
  "message": "Requested changes to cycle cannot be processed. Only cycles in \"SCHEDULED\" status can be cancelled or updated"
}
```
