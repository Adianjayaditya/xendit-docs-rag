---
url: https://docs.xendit.co/apidocs/create-payment-token
title: "Create a new payment token"
section: apidocs
product: xendit
---
...
- Published on Jan 9, 2025
 ...
 [Prev](/apidocs/capture-payment "Capture a payment")  [Next](/apidocs/get-payment-token "Get the status of a payment token") 

Post

/v3/payment\_tokens

Create payment token. Saves end user payment method for future transactions.
...
Create\_Payment\_Token\_Cards
Create\_Payment\_Token\_Ewallet
...
object (Payments\_API\_ChannelPropertiesWidgetSave) Required
  ...
  "actions": [
    {
      ...
      "descriptor": "WEB_URL",
      "value": "https://redirect.partner.com/authentication/ovo?token=ciqv4nkabidq0em86ofg"
    }
  ],
  ...
  "actions": [
    {
      "type": "REDIRECT_CUSTOMER",
      "descriptor": "WEB_URL",
      "value": "https://redirect.xendit.co/authentication/3ds?token=card_auth_token_xyz"
    }
  ],
  "status": "REQUIRES_ACTION",
  "token_details": {
