---
url: https://docs.xendit.co/apidocs/update-subscription-cycle-2
title: "Update Subscription Cycle"
section: apidocs
product: xendit
---
...
- Published on Apr 7, 2026
 ...
 [Prev](/apidocs/get-subscription-cycle-2 "Get Subscription Cycle")  [Next](/apidocs/cancel-subscription-cycle-2 "Cancel Subscription Cycle") 

Patch

/recurring/plans/{plan\_id}/cycles/{id}
...
Amount that recurring plan will charge to end users. Recurring cycles will be generated based on this value. If items param is used, amount should be equivalent to the sum of net\_unit\_amount multiplied by quantity in the items array
...
Successfully updated the recurring cycle.
