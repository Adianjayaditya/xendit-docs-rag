---
url: https://docs.xendit.co/apidocs/create-customer-request
...
- Published on Jul 24, 2025
 ...
 [Prev](/apidocs/get-customers-list "Get customers list")  [Next](/apidocs/get-customer-id "Get customer by id") 
...
A unique key to prevent processing duplicate requests. Can be your reference\_id or any GUID. Must be unique across development & production environments. Idempotency keys are stored on the request layer; it expires after 24 hours from the first request
