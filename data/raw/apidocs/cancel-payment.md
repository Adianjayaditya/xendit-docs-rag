---
url: https://docs.xendit.co/apidocs/cancel-payment
...
- Published on Jan 9, 2025
 ...
 [Prev](/apidocs/get-payment "Get the status of a payment")  [Next](/apidocs/capture-payment "Capture a payment") 

Post

/v3/payments/{payment\_id}/cancel

Cancel a payment. Only applicable for payments in `AUTHORIZED` status.
