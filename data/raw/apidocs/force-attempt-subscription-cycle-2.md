---
url: https://docs.xendit.co/apidocs/force-attempt-subscription-cycle-2
title: "Force Attempt Subscription Cycle"
section: apidocs
product: xendit
---
...
- Published on Apr 7, 2026
 ...
 [Prev](/apidocs/cancel-subscription-cycle-2 "Cancel Subscription Cycle")  [Next](/apidocs/simulate-cycle-payment "Simulate cycle payment") 

Post

/recurring/plans/{plan\_id}/cycles/{id}/force\_attempt

manually force an attempt for the specified action of a subscription cycle before the initial scheduled date.
...
Ineligible request. Safe to retry.
...
```
{
  ...
  "message": "Requested changes to cycle cannot be processed."
}
```
