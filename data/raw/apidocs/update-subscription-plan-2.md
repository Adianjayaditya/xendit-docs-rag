---
url: https://docs.xendit.co/apidocs/update-subscription-plan-2
...
- Published on Apr 7, 2026
 ...
 [Prev](/apidocs/get-subscription-plan-2 "Get Subscription Plan")  [Next](/apidocs/deactivate-subscription-plan-2 "Deactivate Subscription Plan") 
...
Not allowed to set empty array
...
object (Xendit\_Subscriptions\_API\_RecurringScheduleUpdate)
...
Payment token ID is not in eligible status for plan update.
...
Unprocessable entity error. Safe to retry.
...
Example{
"error\_code": "UNPROCESSABLE\_ENTITY\_ERROR",
...
```
 "description": "My newspaper subscription 01",
```
...
```
   "description": "Green apple that is a little sour.",
```
