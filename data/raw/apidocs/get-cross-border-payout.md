---
url: https://docs.xendit.co/apidocs/get-cross-border-payout
title: "Get cross-border payout by Id"
section: apidocs
product: xendit
---
...
- Published on Feb 11, 2025
 ...
 [Prev](/apidocs/cross-border-payout-webhook-notification "Cross-Border Payout Webhook")  [Next](/apidocs/cancel-cross-border-payout "Cancel cross-border payout") 

Get

/remittance\_payouts/{cross\_border\_payout\_id}

This endpoint queries the current status of a cross-border payout.
This is often used for checking the status of a transaction.
...
Cross-Border Payout Found

application/json

getCrossBorderPayoutResponseExample
