---
url: https://docs.xendit.co/docs/withholding-tax-on-gross-remittances-ph
title: Withholding Tax on Gross Remittances
description: ''
section: docs
scraped_at: '2026-04-23T06:19:14.905834Z'
source: https://docs.xendit.co
breadcrumbs:
- DocumentationBillingTax
- Documentation
- Billing
- Tax
---
...
To ensure your documentation is up-to-date with us, please submit a copy of your most updated BIR 2303 and other relevant documents to [tax@xendit.co](mailto:tax@xendit.co). For the taxable year 2024, please **submit these documents as soon as possible**. For 2025 onwards, these documents should be submitted before January 20 of each year.
...
**Determining if Xendit is the Last Payment Facility:** If you receive your remittances directly from Xendit without further disbursing them to your sub-merchants, then Xendit is likely the last facility controlling the payment. To confirm if you are subject to withholding tax on gross remittance, you may reach out to your Account Manager (AM) or contact Customer Support (CS) via [help@xendit.ph](mailto:help@xendit.ph).
...
| Attributes | Prior to RR 16-2023 | After RR 16-2023 |
| --- | --- | --- |
| Total collections/transactions volume (10 transactions\*) | PHP 1,000.00 | PHP 1,000.00 |
| Less: Fees payable to Xendit (P5.60/txn x 10)\* | (PHP 56.00) | (PHP 56.00) |
| Gross collections to be remitted | PHP 944.00 | PHP 944.00 |
| Less: WHT on gross remittance (1% of 50% of gross remittance, e.g., PHP 944 x 0.5%) | PHP 0.00 | (PHP 4.72) |
| **Total remittance to merchant, net of WHT** | **PHP 944.00** | **PHP 939.28** |
...
To request your BIR Form 2307, email [tax@xendit.co](mailto:tax@xendit.co) with the subject: `[Request for BIR Form 2307 for Withholding Tax on Gross Remittance Deduction - Your Business Name]`. We'll provide it by the 20th of the following month.
