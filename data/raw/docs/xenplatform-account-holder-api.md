---
url: https://docs.xendit.co/docs/xenplatform-account-holder-api
title: Overview
description: ''
section: docs
scraped_at: '2026-04-23T06:18:05.416583Z'
...
| 2. Create an Account Holder | [Guide](/docs/create-verification-requests) | [Link](https://docs.xendit.co/apidocs/create-account-holder) |
| 3. Link the Account Holder to your sub-account | [Guide](/docs/create-verification-requests) | [Link](https://docs.xendit.co/apidocs/update-account-holder) |
| 4. Request Capabilities | [Guide](/docs/request-channel-capabilities) | [Link](https://docs.xendit.co/apidocs/update-account-holder) |
| 5. Handle Webhooks | [Guide](/docs/account-holder-webhooks) | [Link](https://docs.xendit.co/apidocs/update-account-holder) |
| 6. Update Account Holder (Resubmission) | [Guide](/docs/updating-verification-information) | [Link](https://docs.xendit.co/apidocs/update-account-holder) |
