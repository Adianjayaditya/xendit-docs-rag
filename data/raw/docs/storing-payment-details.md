---
url: https://docs.xendit.co/docs/storing-payment-details
title: Save Payment Method
description: ''
section: docs
scraped_at: '2026-04-23T06:20:35.583474Z'
...
![](https://cdn.document360.io/217abc43-8677-41fb-a81d-fceeb1fa0358/Images/Documentation/Untitled diagram-2024-12-06-031423.png?sv=2022-11-02&spr=https&st=2026-04-23T06%3A20%3A32Z&se=2026-04-23T06%3A32%3A32Z&sr=c&sp=r&sig=Fk5fi3cTkovi87P3%2BdILJZfLZftf2On6QvOCriCkIhc%3D)
...
4. Upon successful linking, Xendit will send a `payment_session.completed` this webhook contains the `payment_token_id`, which you should securely store for future use. **Optionally**, you can handle `payment_token.activation`webhook to your system to get the token details.
   ...
   - **Future one-off payments**: Refer to the [Pay with Tokens](/docs/pay-with-tokens) guide
   - **Subscription transactions**: Refer to the guides on [Fixed Amount Subscriptions](/docs/fixed-amount-subscriptions) or [Usage-Based Subscriptions](/docs/usage-based-subscriptions).
