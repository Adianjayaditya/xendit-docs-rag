---
url: https://docs.xendit.co/docs/pay-and-save-2
title: Pay and Save
description: ''
section: docs
scraped_at: '2026-04-23T06:07:44.842946Z'
...
![](https://cdn.document360.io/217abc43-8677-41fb-a81d-fceeb1fa0358/Images/Documentation/Untitled diagram-2025-11-04-151034.png?sv=2022-11-02&spr=https&st=2026-04-23T06%3A07%3A41Z&se=2026-04-23T06%3A20%3A41Z&sr=c&sp=r&sig=1Z1dWB%2BNnOuKIW3Jyqq9Jc2RdzDRgtPfpCi%2FawQs73w%3D)
   ...
   2. There are two options on `allow_save_payment_method`:
      ...
      1. **Forced**: Always save the payment details
         ...
         **Response - POST /sessions**
         ...
         ![](https://cdn.document360.io/217abc43-8677-41fb-a81d-fceeb1fa0358/Images/Documentation/image(154).png?sv=2022-11-02&spr=https&st=2026-04-23T06%3A07%3A41Z&se=2026-04-23T06%3A20%3A41Z&sr=c&sp=r&sig=1Z1dWB%2BNnOuKIW3Jyqq9Jc2RdzDRgtPfpCi%2FawQs73w%3D)
      ...
      2. **Optional**: Allows the end user to opt-in to save the payment details\
         ...
         **Response - POST /sessions**
         ...
         ![](https://cdn.document360.io/217abc43-8677-41fb-a81d-fceeb1fa0358/Images/Documentation/image(158).png?sv=2022-11-02&spr=https&st=2026-04-23T06%3A07%3A41Z&se=2026-04-23T06%3A20%3A41Z&sr=c&sp=r&sig=1Z1dWB%2BNnOuKIW3Jyqq9Jc2RdzDRgtPfpCi%2FawQs73w%3D)
...
3. Your customer will complete the payment on the Xendit-hosted page using their preferred payment channel (e.g., cards, eWallets, etc.).
...
4. Your end user will complete their payment process and linking process on Xendit-hosted page
5. Upon successful payment, Xendit will send a `payment_session.completed,` wehbook contains`payment_token_id` which you should securely store for future use. **Optionally**, you can handle `payment.capture` and `payment_token.activated` webhook to your system to see the payment or token details.
