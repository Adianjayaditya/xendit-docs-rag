---
url: https://docs.xendit.co/docs/integration-cross-border-payouts
title: Cross-Border Payouts
description: ''
section: docs
scraped_at: '2026-04-23T06:21:42.952999Z'
source: https://docs.xendit.co
breadcrumbs:
- DocumentationSend moneyIntegration guide
- Documentation
- Send money
- Integration guide
---
...
For more information, see [Setting Up Webhooks](/docs/payouts-set-up-webhooks#setup-your-webhook-url).
