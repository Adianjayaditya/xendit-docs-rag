---
url: https://docs.xendit.co/docs/cards-capturing-a-card-payment
title: Authorize and capture a payment separately
description: Authorize and capture separately
section: docs
scraped_at: '2026-04-23T06:29:43.062808Z'
...
> **Note**
>
> Partial captures are not available in every country. Check our [Cards overview page](/docs/cards-api-overview) for details.
...
If you decide not to capture the funds (e.g., the customer cancels the order), you can void the authorization. This cancels the transaction and releases the hold on the customer's card. Use our [Cancel a payment](/v1/docs/cancel-a-payment-1) endpoint to cancel the authorization using the `payment_id` from the [Authorization](/v1/docs/capturing-a-card-payment#authorization) process
