---
url: https://docs.xendit.co/docs/merchant-initiated-transaction-2
title: Merchant initiated and recurring flagging
description: ''
section: docs
scraped_at: '2026-04-23T06:29:22.846555Z'
...
**CUSTOMER\_UNSCHEDULED** - Use for tokenized cards ([Pay and save](/docs/create-a-token))
...
1. **Create the payment request with the** [**recurring configuration**](/docs/merchant-initiated-transaction-2#recurring-configuration) **in place**\
   Request - POST /v3/payment\_requests
...
2. **This transaction has now been authorized.**\
   Make sure to receive the [webhook or fetch the transaction details](/docs/retrieving-authorization-and-decline-details)
