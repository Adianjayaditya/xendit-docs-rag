---
url: https://docs.xendit.co/docs/create-an-api-key-1
title: Create an API key
description: ''
section: docs
scraped_at: '2026-04-23T06:06:52.311477Z'
...
2. Make sure to set **Write** permissions for your API Key for money-out features.
