---
url: https://docs.xendit.co/docs/cards-network-tokens
title: Network tokens
description: ''
section: docs
scraped_at: '2026-04-23T06:19:42.708126Z'
...
> Xendit is a network token service provider. At the moment we create and leverage network tokens in **Indonesia**, **The** **Philippines**, **Malaysia, Thailand and Vietnam.**
...
**Note:** If you [import](/docs/cards-token-migration) stored cards from another provider, you must re-tokenize them with us to benefit from network tokens.
