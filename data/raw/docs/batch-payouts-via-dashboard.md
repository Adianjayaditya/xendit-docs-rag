---
url: https://docs.xendit.co/docs/batch-payouts-via-dashboard
title: Batch Payouts via dashboard
description: ''
section: docs
scraped_at: '2026-04-23T06:21:34.993318Z'
...
| Channel Code | Required | Destination Channel Code. Refer to [Payout Coverage](https://xendit-docs.document360.io/v1/docs/en/8c02ab02-6095-4b2c-a7d6-53d0c58a9408?isPreview=true&versionNumber=2). |
...
If no transactions need to be validated, you can directly move to [Review and Approve a Batch Payout](https://xendit-docs.document360.io/v1/docs/en/82cd4f6f-ea70-46ee-a4e5-0c69f1f700a5?isPreview=true&versionNumber=2#review-and-approve-a-batch-payout).
