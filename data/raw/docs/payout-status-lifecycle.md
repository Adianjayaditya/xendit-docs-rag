---
url: https://docs.xendit.co/docs/payout-status-lifecycle
title: Payout Status Lifecycle
description: ''
section: docs
scraped_at: '2026-04-23T06:05:00.588929Z'
source: https://docs.xendit.co
breadcrumbs:
- DocumentationSend money
- Documentation
- Send money
---
...
![](https://cdn.document360.io/217abc43-8677-41fb-a81d-fceeb1fa0358/Images/Documentation/Payout Lifecycle-2025-01-15-051640.png?sv=2022-11-02&spr=https&st=2026-04-23T06%3A04%3A57Z&se=2026-04-23T06%3A16%3A57Z&sr=c&sp=r&sig=s%2F%2Fn8LkNaOYs7FmdIuyFOzyAd2pWokDxsq8UWw2XoY4%3D)
...
1. Subscribe to our [webhook events](/docs/payouts-set-up-webhooks) - **(Required for API integration)**
...
After a payout status is `REQUESTED`, it may fail our payout processing or be rejected by the recipient bank, at which point its status will transition to `FAILED`. Subscribe to [Payout webhook events](/docs/payouts-set-up-webhooks) to receive real-time notifications of each payout's failure and its reason.
