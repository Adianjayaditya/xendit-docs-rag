---
url: https://docs.xendit.co/docs/cards-token-migration
title: Card token migration guide
description: ''
section: docs
scraped_at: '2026-04-23T06:19:54.638666Z'
...
You may need to request this data from your previous provider. Once your file is ready,[**encrypt it using the PGP**](/docs/cards-token-migration#how-to-encrypt-files-with-a-pgp-key)key explained in step 1.
...
| `masked_card_number` | Masked version of the card number (e.g. `4111********1111`) |
