---
url: https://docs.xendit.co/docs/create-verification-requests
title: Create verification requests
description: ''
section: docs
scraped_at: '2026-04-23T06:21:22.956759Z'
...
You will need to fill in the required parameters according to your entity type. Refer to the [list of requirements below](/docs/create-verification-requests#requirements-by-country-and-entity-type) to build your request body structure. Upon successful creation, we will return `account_holder_id` .
...
Refer to the [section below](/docs/verify-sub-accounts#owned-subaccount-verification) for the Industry Category codes we support.
