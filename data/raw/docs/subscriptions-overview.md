---
url: https://docs.xendit.co/docs/subscriptions-overview
title: Overview
description: ''
section: docs
scraped_at: '2026-04-23T06:30:28.716765Z'
...
![](https://cdn.document360.io/217abc43-8677-41fb-a81d-fceeb1fa0358/Images/Documentation/Untitled diagram-2024-11-29-033229.png?sv=2022-11-02&spr=https&st=2026-04-23T06%3A30%3A25Z&se=2026-04-23T06%3A44%3A25Z&sr=c&sp=r&sig=2eHfxwP%2BrPa2l8Gwr9o2tER%2F9jOswOO1ZNdEPPoRbZw%3D)
...
| **Attempt** | Represents each action taken to complete a subscription cycle (e.g., payments). Multiple attempts may occur within a single cycle depending on the retry configuration (e.g., a cycle with two retries can have up to three attempts). All attempts are stored within the corresponding cycle object. Each subscription cycle has a one-to-many relationship with its attempts.    A single attempt can involve multiple `payment_token_id` entries if multiple payment methods were configured in the subscription plan. Xendit will process each payment token sequentially, based on priority, until one succeeds or all fail. A subscription attempt has a one-to-many relationship with `payment_token_id`. | Xendit |
...
![](https://cdn.document360.io/217abc43-8677-41fb-a81d-fceeb1fa0358/Images/Documentation/V3 Request Processing-2026-04-07-175902.png?sv=2022-11-02&spr=https&st=2026-04-23T06%3A30%3A25Z&se=2026-04-23T06%3A44%3A25Z&sr=c&sp=r&sig=2eHfxwP%2BrPa2l8Gwr9o2tER%2F9jOswOO1ZNdEPPoRbZw%3D)
...
3. **Subscription plan activated:** Once the subscription plan has been created, you will receive these webhooks:
   ...
   3. `recurring_plan.activated`: The subscription plan becomes active. See the [Plan lifecycle](/v1/docs/overview-12#plan-lifecycle) below.
...
![](https://cdn.document360.io/217abc43-8677-41fb-a81d-fceeb1fa0358/Images/Documentation/V3 Request Processing-2026-04-07-175916.png?sv=2022-11-02&spr=https&st=2026-04-23T06%3A30%3A25Z&se=2026-04-23T06%3A44%3A25Z&sr=c&sp=r&sig=2eHfxwP%2BrPa2l8Gwr9o2tER%2F9jOswOO1ZNdEPPoRbZw%3D)
...
![](https://cdn.document360.io/217abc43-8677-41fb-a81d-fceeb1fa0358/Images/Documentation/V3 Request Processing-2026-04-09-044927.png?sv=2022-11-02&spr=https&st=2026-04-23T06%3A30%3A25Z&se=2026-04-23T06%3A44%3A25Z&sr=c&sp=r&sig=2eHfxwP%2BrPa2l8Gwr9o2tER%2F9jOswOO1ZNdEPPoRbZw%3D)

| **Status** | **Description** | Webhook event |
| --- | --- | --- |
| Pending | If `payment_tokens` are provided during plan creation, the plan status may on the `PENDING`. Wait for the `recurring.plan.activated` webhook to confirm activation. |  |
...
![](https://cdn.document360.io/217abc43-8677-41fb-a81d-fceeb1fa0358/Images/Documentation/Untitled diagram-2024-12-08-125117.png?sv=2022-11-02&spr=https&st=2026-04-23T06%3A30%3A25Z&se=2026-04-23T06%3A44%3A25Z&sr=c&sp=r&sig=2eHfxwP%2BrPa2l8Gwr9o2tER%2F9jOswOO1ZNdEPPoRbZw%3D)
