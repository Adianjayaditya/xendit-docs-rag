---
url: https://docs.xendit.co/docs/authorize-and-capture-1
title: Authorization and Capture Flow (Manual Capture)
description: ''
section: docs
scraped_at: '2026-04-23T06:20:47.295866Z'
...
Upon successful authorization, Xendit will send a `payment_session.completed` webhook. The webhook contains the `payment_id` with status `AUTHORIZED`. You should store the `payment_id,`mark the order as **authorized,** andcapture the payment once the order or service is confirmed.
